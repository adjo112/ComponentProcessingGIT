...
namespace ComponentProcessing
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<CompContext>(options =>
            {
            ...
            services.AddTransient<IBusinessL, BusinessL>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ComponentProcessing", Version = "v1" });
            });
        }
